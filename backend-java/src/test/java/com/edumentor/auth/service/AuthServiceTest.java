...
class AuthServiceTest {
    ...
    void setUp() {
        ...
        mockUser.setRole(RoleConstant.STUDENT);
        mockUser.setActive(true);
        mockUser.setLastLoginAt(OffsetDateTime.now());
    ...
    class RegisterTests {
        ...
        void registerStudentSuccess() {
            RegisterRequest request = new RegisterRequest(
                    "newstudent", "password123", "新同学", "new@example.com", "STUDENT");
        ...
        void registerWithNullRoleDefaultsToStudent() {
            RegisterRequest request = new RegisterRequest(
                    "student2", "password123", null, null, null);
        ...
        void usernameAlreadyExists() {
            RegisterRequest request = new RegisterRequest(
                    "existing", "password123", null, null, "STUDENT");
        ...
        void emailAlreadyExists() {
            RegisterRequest request = new RegisterRequest(
                    "newuser", "password123", null, "dup@example.com", "STUDENT");
        ...
        void invalidRole() {
            RegisterRequest request = new RegisterRequest(
                    "newuser", "password123", null, null, "SUPER_ADMIN");
        ...
        void registerTeacher() {
            RegisterRequest request = new RegisterRequest(
                    "teacher1", "password123", "张老师", "teacher@school.com", "TEACHER");
    ...
    class LoginTests {
        ...
        void loginSuccess() {
            ...
            when(authentication.getAuthorities())
                    .thenReturn(List.of(new SimpleGrantedAuthority("ROLE_STUDENT")));
